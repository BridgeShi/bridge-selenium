...
public class Init1688CompanyOfferDAO {

	private static final String Ali1688_OFFERS = "create table Ali1688_Company_Offers ("
			+ "productname VARCHAR(100), productUrl VARCHAR(500), price VARCHAR(100), "
			+ "companyname VARCHAR(100), companyurl VARCHAR(500), counts VARCHAR(100)) "
